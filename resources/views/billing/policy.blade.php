...
<body class="hold-transition login-page">
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100" style="padding-bottom: 30px;width: 1350px;">
...
<br>
<h5>INFORMASI PRIBADI YANG KAMI KUMPULKAN</h5>
<br>
Berikut adalah contoh jenis informasi pribadi yang dapat dikumpulkan beserta cara menggunakannya. 
• Saat Anda membuat akun, menghubungi kami, atau mengikuti pengisian online, kami dapat mengumpulkan berbagai informasi, termasuk nama dan informasi kontak (telepon, surel), alamat korespondensi, nomor telepon, alamat email, preferensi kontak, jenis kelamin.
<br>
• Kami dapat meminta tanda pengenal yang dikeluarkan pemerintah dalam kondisi tertentu termasuk bila diwajibkan berdasarkan hukum.
 
<br>

<br>
<h5>PENGGUNAAN INFORMASI PRIBADI</h5>
<br>
• Informasi pribadi yang kami kumpulkan memungkinkan kami terus mengabari Anda tentang pemberitahuan informasi tagihan kepada anda. Jika tidak ingin disertakan lagi dalam milis kami, Anda dapat keluar kapan pun dengan memperbarui preferensi.
<br>
• Kami juga menggunakan informasi pribadi untuk membantu membuat, mengembangkan, mengoperasikan, memberikan, dan meningkatkan sistem kami, serta untuk mencegah kehilangan dan penipuan.
<br>
• Kami dapat menggunakan informasi pribadi Anda, termasuk tanggal lahir, untuk melakukan verifikasi identitas, membantu mengidentifikasi pengguna, atau menentukan layanan yang tepat. Misalnya, kami dapat menggunakan tanggal lahir untuk menentukan usia pemegang akun.
<br>
• Kami menggunakan informasi pribadi seperti nama, nomor telepon, alamat surel, alamat tempat tinggal, dan perusahaan/institusi untuk dapat berhubungan dengan pelanggan.
<br>
• Kami dapat menggunakan informasi pribadi Anda untuk memberikan dukungan atau layanan lain yang terkait dengan transaksi yang telah dilakukan pelanggan, seperti keluhan pelanggan, panggilan pelanggan, konfirmasi pelanggan terkait transaksi, dan banyak layanan pelanggan lainnya yang terkait dengan transaksi tersebut.
<br>
• Kami menggunakan informasi pribadi untuk mencegah aktifitas ilegal yang potensial dan menegakkan Syarat dan Ketentuan Kami. Kami juga menggunakan bermacam-macam sistem teknologi untuk mendeteksi aktifitas yang tidak lazim untuk penyalahgunaan, seperti spam.
<br>
• Dari waktu ke waktu, kami dapat menggunakan informasi pribadi untuk mengirimi Anda pemberitahuan penting, seperti komunikasi tentang pembelian serta perubahan persyaratan, ketentuan, dan kebijakan kami. Karena informasi ini penting untuk berinteraksi dengan kami,
<br>
• Dari waktu ke waktu, Kami dapat meminta Anda untuk memberikan saran-saran, agar produk/layanan lebih sesuai dengan yang Anda butuhkan dan minati (sebagai contoh lewat survei, riset atas penggunaan, diskusi kelompok).
<br> 
...
<br>
Dengan menggunakan Situs-web/Aplikasi/layanan Kami, berarti Anda menyatakan bahwa Anda telah membaca dan mengerti Kebijakan Privasi ini dan Ketentuan Penggunaan dan setuju serta memperkenakan Kami untuk menggunakan, menerapkan, memproses, dan mengalihkan informasi pribadi Anda sebagaiamana dinyatakan dalam Kebijakan Privasi ini. 
<br>
Anda juga menyatakan bahwa Anda berhak untuk membagikan atas seluruh informasi yang telah diberikan kepada Kami dan memberikan kepada Kami kewenangan untuk menggunakan dan membagikan informasi pribadi Anda untuk mendukung dan melaksanakan layanan Kami. 
            ...
            <div class="text-center p-t-12">
              <a class="txt2" href="{{url('register')}}">
                ...
                <b style="font-size:16px">Back To Register</b>
              </a>
            </div>
