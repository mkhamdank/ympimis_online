        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                @if(isset($page) && $page == "Outgoing True")<li class="sidebar-item active">@else<li class="sidebar-item">@endif
                  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/index/outgoing/true') }}"><i class="fa fa-book"></i> <span class="hide-menu">Outgoing PT. TRUE</span></a>
                </li>
                @endif
                ...
                @if(isset($page) && $page == "Outgoing KBI")<li class="sidebar-item active">@else<li class="sidebar-item">@endif
                  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/index/outgoing/kbi') }}"><i class="fa fa-book"></i> <span class="hide-menu">Outgoing KBI</span></a>
                </li>
                @endif
                ...
                @if(isset($page) && $page == "Outgoing ARISA")<li class="sidebar-item active">@else<li class="sidebar-item">@endif
                  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/index/outgoing/arisa') }}"><i class="fa fa-book"></i> <span class="hide-menu">Outgoing ARISA</span></a>
                </li>
                @endif
                @endif
