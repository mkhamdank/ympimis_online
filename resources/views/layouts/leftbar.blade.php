  ...
  <div class="scroll-sidebar">
    ...
    <nav class="sidebar-nav">
      <ul id="sidebarnav">
        ...
        @if(isset($page) && $page == "Outgoing Crestec")<li class="sidebar-item active">@else<li class="sidebar-item">@endif
          <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/index/outgoing/crestec') }}"><i class="fa fa-book"></i> <span class="hide-menu">VFI PT. CRESTEC INDONESIA</span></a>
        </li>
        @endif
        @endif
        ...
        @if(isset($page) && $page == "Outgoing CPP")<li class="sidebar-item active">@else<li class="sidebar-item">@endif
          <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/index/outgoing/cpp') }}"><i class="fa fa-book"></i> <span class="hide-menu">VFI PT. CPP</span></a>
        </li>
        @endif


        @if(Auth::user()->role_code == 'FA-Check1' || Auth::user()->role_code == 'FA-Check2' || Auth::user()->role_code == 'MIS')
