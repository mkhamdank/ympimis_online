...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">Critical Defect PT. KYORAKU BLOWMOLDING INDONESIA</span><br>
		...
		<center>
				<table style="border:1px solid black; border-collapse: collapse;" width="60%">
					<thead style="text-align: center;">
						...
						<tr>
							<th style="border:1px solid black;font-weight: bold;background-color: rgb(126,86,134);color: white;">Defect</th>
							<td style="border:1px solid black;text-align: left">
								{{$data['ng_name']}}
							</td>
						</tr>
						<tr>
							<th style="border:1px solid black;font-weight: bold;background-color: rgb(126,86,134);color: white;">Qty Defect</th>
							<td style="border:1px solid black;text-align: right;">
								{{$data['ng_qty']}}
							</td>
						</tr>
